...
export const Hero = () => {
  return (
    <section id="top" className="relative min-h-[90dvh] flex items-end overflow-hidden">
      <img
        src={heroImg}
      ...
      <div className="container relative z-10 pb-16 pt-24 sm:pb-20 sm:pt-32">
        <div className="max-w-2xl space-y-4 sm:space-y-5 animate-fade-in">
          ...
          <h1 className="font-display font-extrabold text-white leading-[1.05]"
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2 pt-2 text-white/85 text-xs sm:text-sm">
